...
var file_file_proto_rawDesc = []byte{
	...
	0x42, 0x06, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xae, 0x04, 0x0a, 0x15, 0x53, 0x61, 0x66,
	...
	0x10, 0x09, 0x32, 0xbb, 0x0c, 0x0a, 0x0b, 0x46, 0x69, 0x6c, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x46, 0x69, 0x6c,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x12, 0x55, 0x0a, 0x0e, 0x53,
	...
	0x30, 0x01, 0x12, 0x43, 0x0a, 0x0c, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x46, 0x69,
	...
	0x6d, 0x46, 0x69, 0x6c, 0x65, 0x30, 0x01, 0x12, 0x4e, 0x0a, 0x0d, 0x55, 0x70, 0x6c, 0x6f, 0x61,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x57, 0x0a, 0x10, 0x47, 0x65, 0x6e, 0x65, 0x72,
	0x61, 0x74, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x12, 0x20, 0x2e, 0x73, 0x74,
	0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x46, 0x69,
	0x6c, 0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x21, 0x2e,
	...
	0x12, 0x63, 0x0a, 0x14, 0x42, 0x75, 0x6c, 0x6b, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65,
	0x46, 0x69, 0x6c, 0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x12, 0x24, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x62, 0x0a, 0x0b, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x46,
	...
	0x42, 0x84, 0x01, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65,
	0x42, 0x09, 0x46, 0x69, 0x6c, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2e, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x77, 0x65, 0x62, 0x69, 0x74, 0x65,
	0x6c, 0x2f, 0x77, 0x65, 0x62, 0x72, 0x74, 0x63, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0xa2, 0x02, 0x03,
...
var file_file_proto_goTypes = []interface{}{
	...
	(*SearchFilesByCallRequest)(nil),             // 29: storage.SearchFilesByCallRequest
...
var file_file_proto_depIdxs = []int32{
	...
	30, // 16: storage.GenerateFileLinkRequest.query:type_name -> storage.GenerateFileLinkRequest.QueryEntry
	31, // 17: storage.GenerateFileLinkResponse.metadata:type_name -> storage.GenerateFileLinkResponse.Metadata
	32, // 18: storage.StreamFile.metadata:type_name -> storage.StreamFile.Metadata
	...
	33, // 24: storage.UploadFileRequest.metadata:type_name -> storage.UploadFileRequest.Metadata
	34, // 25: storage.SafeUploadFileRequest.metadata:type_name -> storage.SafeUploadFileRequest.Metadata
	36, // 26: storage.SafeUploadFileResponse.part:type_name -> storage.SafeUploadFileResponse.Part
	35, // 27: storage.SafeUploadFileResponse.metadata:type_name -> storage.SafeUploadFileResponse.Metadata
	37, // 28: storage.SafeUploadFileResponse.progress:type_name -> storage.SafeUploadFileResponse.Progress
	...
	38, // 32: storage.SearchFilesByCallRequest.uploaded_at:type_name -> engine.FilterBetween
	38, // 33: storage.SearchFilesByCallRequest.retention_until:type_name -> engine.FilterBetween
	...
	26, // 44: storage.FileService.SafeUploadFile:input_type -> storage.SafeUploadFileRequest
	...
	29, // 57: storage.FileService.SearchFilesByCall:input_type -> storage.SearchFilesByCallRequest
	28, // 58: storage.FileService.UploadFile:output_type -> storage.UploadFileResponse
	27, // 59: storage.FileService.SafeUploadFile:output_type -> storage.SafeUploadFileResponse
